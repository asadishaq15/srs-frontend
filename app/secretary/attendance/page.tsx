...
export default function AttendancePage() {
  ...
  const handleLoadAttendance = async () => {
    if (!selectedCourse || !selectedSection || !roomNumber || !selectedDate) {
      ...
      {noDataMessage ? (
        ...
        <>
          ...
          <Card>
                    ...
                    <TableRow key={student._id}>
                      ...
                      <TableCell>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem
                              onClick={() => {
                                updateAttendanceStatus(student._id, "Present")
                                setHasChanges(true)
                              }}
                            >
                              Present
                            ...
                            <DropdownMenuItem
                              onClick={() => {
                                updateAttendanceStatus(student._id, "Absent")
                                setHasChanges(true)
                              }}
                            >
                              Absent
                            ...
                            <DropdownMenuItem
                              onClick={() => {
                                updateAttendanceStatus(student._id, "Late")
                                setHasChanges(true)
                              }}
                            >
                              Late
                            ...
                            <DropdownMenuItem
                              onClick={() => {
                                updateAttendanceStatus(student._id, "Excused")
                                setHasChanges(true)
                              }}
                            >
                              Excused
                      ...
                      <TableCell>
                        <Input
                          ...
                          value={student.note}
                          onChange={(e) => {
                            updateStudentNote(student._id, e.target.value)
                            setHasChanges(true)
                          }}
            ...
            {!creatingAttendance && hasChanges && (
              <div className="flex justify-end p-4">
                <Button
                  onClick={async () => {
                    if (!attendanceData || !selectedCourse || !roomNumber || !selectedSection || !selectedDate) {
                    ...
                    try {
                      ...
                      const response = await axios.put(
                        `${process.env.NEXT_PUBLIC_SRS_SERVER}/attendance/updateAttendance`,
                        payload,
                      )
